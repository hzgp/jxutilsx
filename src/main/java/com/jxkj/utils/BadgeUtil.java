...
public class BadgeUtil {
    ...
    public static void setBadgeCount(Context context, int count, int iconResId) {
        ...
        }else if (Build.MANUFACTURER.toLowerCase().contains("HUAWEI")||Build.MANUFACTURER.toLowerCase().contains("huawei")||Build.BRAND.equals("Huawei")||Build.BRAND.equals("HONOR")||Build.BRAND.equals("HUAWEI")) {//华为
