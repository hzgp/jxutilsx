...
public class AESUtil {
    ...
    public static String decryptStr(String data) throws Exception {
        ...
        // 解密
        byte[] content = Base64.decode(data.getBytes("utf-8"),Base64.DEFAULT);

        // 解密
        byte[] key = Base64.decode(JXConfig.getInstance().getConfigLoader().AES_KEY().getBytes("utf-8"),Base64.DEFAULT);
        // 还原密钥
        Key k = toKey(key);
    ...
    public static String decrypt(byte[] data) throws Exception {
        ...
        // 解密
        byte[] content = Base64.decode(new String(data).getBytes("utf-8"),Base64.DEFAULT);
    ...
    public static String encrypt(String str) throws Exception {
        ...
        // 执行操作
        return new String(Base64.encode(cipher.doFinal(data),Base64.DEFAULT), "utf-8");
    }
