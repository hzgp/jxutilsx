package com.jxkj.utils.statusBar;
...
public class StatusBarSetting {
    ...
    public static void bind(int barViewId, int translucentViewId) {
        FAKE_STATUS_BAR_VIEW_ID = barViewId;
        FAKE_TRANSLUCENT_VIEW_ID = translucentViewId;
    }
     ...
     * 隐藏伪状态栏 View
     *
     * @param activity 调用的 DesignerDetailActivity
     */
